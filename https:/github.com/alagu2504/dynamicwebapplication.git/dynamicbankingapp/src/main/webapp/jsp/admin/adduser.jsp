...
<body>
	...
	<form action="bankingservlet" method="post" target="mainframe">
		<table style="padding-left:0px;">
			<tr >
				<td ><input class=" submitButton submitHover" style="margin-left:150px;" type="submit" name="action" value="ADD ADMIN"/></td>
				<td><input  class=" submitButton submitHover" style="margin-right:30px%;" type="submit" name="action" value="ADD CUSTOMER"></td>
			</tr>
		</table>
