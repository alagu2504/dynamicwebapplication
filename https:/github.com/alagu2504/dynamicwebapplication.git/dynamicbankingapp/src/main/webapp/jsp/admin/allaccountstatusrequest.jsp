		...
		<table>
			...
			<c:forEach items="${accountActiveRequest }" var="request">
				...
				<tr>
					...
					<td><input style="background: transparent;text-align:center;font-size:15px;border: 0;width:98%;height:60px;" type="text" name="description"
					...
					<td><input style="background: transparent;text-align:center;font-size:15px;border: 0;" type="text" name="status"
						value="${ request.getStatus()}" readonly></td>
