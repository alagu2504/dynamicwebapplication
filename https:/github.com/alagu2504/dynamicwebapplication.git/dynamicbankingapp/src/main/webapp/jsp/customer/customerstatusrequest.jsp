		...
		<form action="bankingservlet" method="post">
			<table class="center">
				...
				<tr>
					...
					<td style="padding-left: 8px;"><textarea
							style="height: 90px; width: 50%; border-radius: 10px;"
							id="description" name="description" rows="4" cols="50" required></textarea></td>
				</tr>
			</table>
			<input type="hidden" name="action" value="Change Customer Status">

			<div>
				<input class="submitButton submitHover" style="margin-left: 43%;"
