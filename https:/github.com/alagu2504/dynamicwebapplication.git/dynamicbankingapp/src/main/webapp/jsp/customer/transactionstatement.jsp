...
<h2 style="text-align: center;">Transaction Statements</h2>
	...
	<form action="bankingservlet" method="post">
		...
		<label style="margin-left:15%;font-size:20px;margin-top:20px;">Account Number </label>
		 <select  class="textFeild" name="accountNumber" id="accountNumber">
		...
		<input class="textFeild" style="display:inline;" type="number" name="days" placeholder="Enter number Of Days"/> 
		</div>
				<input class="submitButton submitHover"  style="margin-left:40%;margin-top:5%;" type="submit" name="action" value="STATEMENTS">
