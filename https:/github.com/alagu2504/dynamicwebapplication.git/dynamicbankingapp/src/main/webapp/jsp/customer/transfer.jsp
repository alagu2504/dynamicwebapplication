		...
		<form action="bankingservlet" method="post">
			...
			<table class="center">
				<tr>
					...
					<td><select class="textFeild" style="height:34px;width: 100%;margin-left:2px;" name="senderAccountnumber">
				...
				<tr>
					<td style="text-align:left;padding-top:20px;"><label style="padding-right:50px;font-size:20px;" for="receiveraccount">Receiver Account
							Number</label></td>
				...
				<tr>
					<td style="text-align:left;padding-top:20px;"><label style="padding-right:50px;font-size:20px;" for="transferamount">Transfer Amount</label></td>
				...
				<tr>
					<td  style="text-align:left;padding-top:20px;"><label style="padding-right:50px;font-size:20px;" for="password">Password </label></td>
