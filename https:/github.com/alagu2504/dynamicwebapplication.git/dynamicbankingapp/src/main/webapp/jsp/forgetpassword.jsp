...
<body>
	<div class="container">
		<h2 class="subHeading" style="margin-bottom: -10px;">Forget
			Password</h2>
		...
		<form action="bankingservlet" method="post" target="mainframe">
			...
			<table class="center">
				...
				<tr>
					...
					<td><input class="textFeild" type="number" name="userId"
				...
				<tr>
					...
					<td><input type="password" id="newpassword" name="newpassword"
						placeholder="Newpassword" required></td>
				</tr>
			...
			<input class="submitButton submitHover "
				style="margin-top: 5px; margin-left: 48%; width: 30%;" type="submit"
				name="submit" value="CHANGE PASSOWRD" /> <input type="hidden"
				name="action" value="FORGET PASSWORD">
