...
<h2  style="margin-top:30px;">Change Password</h2>
 ...
 <h4>${error}</h4>
  ...
  <tr>
        <td  style="padding-right:50px;padding-top:20px;font-size:20px;"> <label  for="confirm_password">Confirm Password</label></td>
        <td >  <input   class= "textFeild" type="password" id="confirm_password" name="confirm_password" placeholder="confirmpassword" required>
  </td>
  </tr>
</table>
  
  
  <input  style="margin-left:53.5%;margin-top:10px;" class="submitButton submitHover" type="submit" name ="action" value="CHANGE PASSWORD">
