...
<body>
	...
	<form action="bankingservlet" method="post" target="mainframe">
		...
		<table >
			...
			<tr>
				<th>Date of Birth </th>
				<td><input class="textFeild" type="date" id="dateofbirth" name="dateofbirth"
					required></td>
			</tr>
			<tr>
				<th>Mobile Number </th>
			...
			<tr>
				<th>Email Id </th>
				<td><input class="textFeild" type="email" id="emailid" name="emailid"
			...
			<tr>
				...
				<td><input class="textFeild" type="number" id="aadhaarNo" name="aadhaarNo"
					placeholder="Enter Aadhaar Number" required></td>
			</tr>

			<tr>
				<th>Pan Card Number </th>
				<td><input class="textFeild" type="text" id="panCardNo" name="panCardNo"
					placeholder="Enter Pan Card number" required></td>
			</tr>

			<tr>
				<td></td>
				<td><input class="submitButton submitHover" type="submit" name="submit" value="SUBMIT">
				</td>
			</tr>
		</table>
		<input type="hidden" id="status" name="status" value="Active" readonly>
		<input type="hidden" id="role" name="role" value="Customer" readonly>
