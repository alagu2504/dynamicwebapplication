...
<body>
	...
	<form action="bankingservlet" method="post" target="mainframe">
		<table class="center">
			...
			<tr>
				...
				<td><input class="textFeild" type="text" id="dateOfBirth" name="dateOfBirth"
					value="${user.getDataOfBirth() }" readonly required></td>
			</tr>
			...
			<tr>
				...
				<td><input class="textFeild" type="number" id="mobileNumber" name="mobileNumber"
					value="${user.getMobileNumber() }" required></td>
			</tr>
			...
			<tr>
				...
				<td><input class="textFeild"  type="text" id="address" name="address"
					value="${user.getAddress() }" required></td>
			</tr>
			...
			<tr>
				<td></td>
				<td style="padding-left:1px;"><input class="submitButton submitHover" type="submit" name="save" value="Save"
		...
		<input type="hidden" name="userId"
			...
			type="hidden" name="role" value="${user.getRole()}" /> 
			<input type="hidden" name="action" value="Update UserInfo"/>
	</form>
	</div>
